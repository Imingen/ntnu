...
class BasicClientActor(BasicClientActorAbs):
    def __init__(self, IP_address = None,verbose=True):
        ...
        self.model = keras.models.load_model("/home/marius/ntnu/ai-progg/asgn3/models_5x5/")
    ...
    def handle_get_action(self, state):
        ...
        net_man = NeuralNet(0.1, 199, 2)
        action = net_man.neural_magic(self.model, state, state[0])
        action = self.model.
        print(action)
